...
public class FollowingCarModelLayer extends RenderLayer<FollowingCar,FollowingCarModel<FollowingCar>>{
	...
	public static HashMap<Integer,BakedModel> BakedColorModels = new HashMap<Integer,BakedModel>();
        	 ...
        	 if(model != null ){
        		 ...
        		 if(bodymodel != null && wheelmodel != null && scalelist != null && colormodel != null) {
		             ...
		             try {
		            	 ...
		            	 if(BakedColorModels.get(type) == null){
		            		 
		            		 colorbakedmodel = cachequads(colorbakedmodel, colorblockstate);
		            		 BakedColorModels.put(type,colorbakedmodel);
		            	 }
	            		    
	            		    
	            		 FollowingCarModelLayer.renderBlockOnEntity(p_117349_, p_117350_, p_117351_, flag, blockrenderdispatcher, colorblockstate, coords, BakedColorModels.get(type), new Vec3(afloat[0],afloat[1],afloat[2]),false);
	            		 p_117349_.popPose();
		             }
		             catch(Exception e) {
