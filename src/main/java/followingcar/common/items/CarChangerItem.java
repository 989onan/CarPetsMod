...
public class CarChangerItem extends Item{
	...
	public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> tooltip, TooltipFlag p_41424_) {
		MutableComponent text = Component.literal(this.tooltip);
		...
		if(CarTypeRegistry.CarTypes.get((int) compoundtag.getShort("CarType")) != null) {
			tooltip.add(Component.literal("Selected car type is: "+CarTypeRegistry.CarTypes.get((int) compoundtag.getShort("CarType")).getName()));
		}
		else {
			tooltip.add(Component.literal("Selected car type is: MISSING NO AHHHHHHHHHHHHHH"));
		}
	}
